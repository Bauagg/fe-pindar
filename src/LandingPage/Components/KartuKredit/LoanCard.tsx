    ...
    <>
      <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition overflow-hidden group">
        ...
        <div className="p-5 space-y-4">
          {/* TITLE */}
          <div>
            <h3 className="text-xl md:text-xl font-bold text-gray-800 line-clamp-2">{data.title}</h3>

            <p className="mt-2 text-red-500 font-black text-xl md:text-xl">Rp {Number(data.yearlyFee).toLocaleString("id-ID")}</p>
